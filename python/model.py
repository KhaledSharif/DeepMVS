...
class DeepMVS(nn.Module):
	...
	def forward_feature(self, volume_input, feature_inputs):
		...
		layer_2_d8x_out = self.layer_2_d8x(torch.cat((layer_2_e8x_out, F.interpolate(layer_2_d16x_out, scale_factor=2, mode='bilinear', align_corners=True), layer_b8x_out), 1))
		layer_2_d4x_out = self.layer_2_d4x(torch.cat((layer_2_e4x_out, F.interpolate(layer_2_d8x_out, scale_factor=2, mode='bilinear', align_corners=True), layer_b4x_out), 1))
		layer_2_d2x_out = self.layer_2_d2x(torch.cat((layer_2_e2x_out, F.interpolate(layer_2_d4x_out, scale_factor=2, mode='bilinear', align_corners=True), layer_b2x_out), 1))
		layer_2_d1x_out = self.layer_2_d1x(torch.cat((layer_2_e1x_out, F.interpolate(layer_2_d2x_out, scale_factor=2, mode='bilinear', align_corners=True), layer_b1x_out), 1))
